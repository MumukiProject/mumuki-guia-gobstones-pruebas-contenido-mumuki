...
function open() {
  $('img[src="https://raw.githubusercontent.com/MumukiProject/mumuki-guia-gobstones-pruebas-contenido-mumuki/master/assets/choice_1597255722913.gif"]').css('display', 'block')
}
function close() {
